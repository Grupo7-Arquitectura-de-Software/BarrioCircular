  ...
  return (
    <VStack gap={4} align="stretch" w="100%">
      <Box>
        ...
        <SelectorDesplegable titulo="Tipo de material" colecciondeDatos={tiposMaterial} />
      </Box>

      <CampoFormulario etiqueta="Peso estimado (kg)" marcadorPosicion="e.g., 10" />

      <CampoFormulario etiqueta="Precio referencial (e.g., $5.00)" marcadorPosicion="$0.00" />

      <AreaCargaImagenes etiqueta="Upload Foto" maximoArchivos={3} />

      <CampoFormulario etiqueta="Ubicación de recogida" marcadorPosicion="Quito Map/Address" />
