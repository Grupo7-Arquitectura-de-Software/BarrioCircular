...
const MENSAJES_EJEMPLO = [
    { id: 1, texto: "Hola 14:30 pocas 22:00", emisor: "propio", hora: "14:30", nombreEmisor: "Vendedor" },
    { id: 2, texto: "Hacía el tiempo y buagaciones?", emisor: "propio", hora: "14:31", nombreEmisor: "Vendedor" },
    { id: 3, texto: "Tiempo y la locación en: Maps://cncs", emisor: "otro", hora: "14:35", nombreEmisor: "Reciclador Juan" },
...
const ChatdeCoordinacion = ({ mensajes = MENSAJES_EJEMPLO}) => {
    return (
        <VStack gap={0} align="stretch" h="100%" border="1px solid" borderColor="gray.200" borderRadius="md">
            {/* Área de mensajes */}
