...
export const useEmparejamiento = () => {
  ...
  const buscar = useCallback(async (filtros) => {
    ...
    try {
      ...
      const tiposMateriales = filtros.tipoMaterial && filtros.tipoMaterial !== "TODOS" 
      ...
      const payload = {
        ...
        longitud: -78.467838,
        radioMaximoKm: filtros.distancia === "0" ? 50 : (filtros.distancia ? Number(filtros.distancia) : 5),
