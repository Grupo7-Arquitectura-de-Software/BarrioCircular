...
public record IdentificadorUsuarioClerk(String valor) {
  ...
  public IdentificadorUsuarioClerk {
    if (valor == null || valor.isBlank()) {
      throw new IdentificadorUsuarioClerkExcepcion(
          valor, "El ID de clerk no puede ser vacio o nulo");
    }
    if (!valor.startsWith(PREFIJO_CLERK)) {
      throw new IdentificadorUsuarioClerkExcepcion(
          valor, "Debe comenzar con el prefijo obligatorio" + PREFIJO_CLERK + ".");
    }
  }
}
