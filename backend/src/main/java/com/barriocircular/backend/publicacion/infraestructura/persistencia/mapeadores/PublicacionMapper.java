...
public class PublicacionMapper {
  ...
  public Publicacion toDomain(PublicacionEntity entity) {
    DetalleMaterial detalle =
        new DetalleMaterial(
            TipoResiduo.valueOf(entity.getTipoResiduo()), PesoEstimado.deKilos(entity.getPesoKg()));

    ReservadorId reservadoPor =
        entity.getReservadoPor() == null ? null : ReservadorId.de(entity.getReservadoPor());
