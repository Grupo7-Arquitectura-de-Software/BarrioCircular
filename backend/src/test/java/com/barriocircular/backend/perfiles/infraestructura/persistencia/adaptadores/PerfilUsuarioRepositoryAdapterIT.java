...
class PerfilUsuarioRepositoryAdapterIT {
    ...
    @Autowired
    private PerfilUsuarioRepositoryAdapter adapter;

    @Autowired
    private SpringDataPerfilUsuarioRepository springDataRepository;
    ...
    void guardaYRecuperaPerfilUsuarioConValueObjects() {
        ...
        assertEquals("ana-" + cuentaUsuarioId + "@correo.com",
